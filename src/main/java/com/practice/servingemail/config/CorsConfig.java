package com.practice.servingemail.config;
...
import static com.practice.servingemail.constant.Constant.X_REQUESTED_WITH;
...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3030", "http://localhost:5173"));
